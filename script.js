...
async function init() {
  ...
  tokenClient = google.accounts.oauth2.initTokenClient({
    ...
    callback: async (resp) => {
      ...
      // Refresh calendar every minute WITHOUT reloading page
...
function emojiFor(title) {
  ...
  if (t.includes("cup") || t.includes("soccer") || t.includes("lions")) return "📌";
...
function dayLabel(date, index) {
  ...
  return date.toLocaleDateString("en-SG", { weekday: "long", timeZone: "Asia/Singapore" });
  ...
  for (let i = 0; i < 4; i++) {
    ...
    card.innerHTML = `
      ...
      <div class="day-date">
        ...
        ${day.toLocaleDateString("en-SG", { day: "numeric", month: "short", timeZone: "Asia/Singapore" })}
